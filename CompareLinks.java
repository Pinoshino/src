...
public class CompareLinks {
    ...
    public static void main(String[] args) {
        int num=0;
        ArrayList<LinkData> linkList1 = LinkImporter.importFun_CodeLink(file1);  // file1のコードリンクを格納
        ArrayList<LinkData> linkList2 = LinkImporter.importFun_CodeLink(file2);  // file2のコードリンクを格納
